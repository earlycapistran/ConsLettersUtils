...
#' in ' mice'
#' @param obs A fitted model object created with observed data only (e.g., an
#' nls model object created with observed dataset that has missing values).
#' @return A plot of residual vs. fited values
#' @examples
#' obsImpResiPlot(mira_object, nls_model)
#' 
#' @import mice
#' @import graphics

obsImpResiPlot <- function(mira, obs) {
